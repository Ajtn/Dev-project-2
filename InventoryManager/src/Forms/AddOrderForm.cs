...
namespace MyGame
{
    public class AddOrderForm
    {
        ...
        public AddOrderForm()
        {
            ...
            fLabels[4] = new Label();
            fLabels[4].Text = "Quantity Ordered";
            fLabels[4].Left = 20;
            fLabels[4].Top = 180;
            ...
            fTextBoxes[6] = new TextBox();
            fTextBoxes[6].Left = 120;
            fTextBoxes[6].Top = 240;
            fForm.Controls.Add(fTextBoxes[6]);

            fLabels[6] = new Label();
            fLabels[6].Text = "Employee Name";
            fLabels[6].Left = 20;
            fLabels[6].Top = 240;
            fForm.Controls.Add(fLabels[6]);
